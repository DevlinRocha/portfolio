    ...
    return (
        ...
        >
            ...
            <img
                ...
                // alt={image.alt}
                onLoad={handleLoad}
                className={`group-hover:scale-101 h-40 bg-neutral-50 object-contain transition-transform duration-500 sm:h-[188px] ${loading && image ? 'animate-loading' : 'animate-none'} ${featured ? 'md:h-[255px] lg:h-[362px]' : 'lg:h-[270px]'}`}
            />
