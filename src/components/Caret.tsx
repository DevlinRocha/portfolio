...
function Caret({ disabled, onClick, className }: CaretProps) {
    return (
        <button
            disabled={disabled}
            onClick={onClick}
            className="rounded-full bg-neutral-600/70 transition-colors disabled:bg-neutral-600/35 group-hover:bg-neutral-600 disabled:group-hover:bg-neutral-600/35"
        >
            <svg
                width="5"
                height="5"
